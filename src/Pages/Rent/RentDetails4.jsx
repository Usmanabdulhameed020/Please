...
export default function RentDetails4() {
  const property = {
    id: 4,
    ...
    description:
      "Spacious 3-bedroom terrace duplex in Gbagada with modern interior, fitted kitchen, and ample parking space. Perfect for families seeking comfort and security.",
    features: [
      "3 Bedrooms",
      "3 Toilets",
      "Fitted Kitchen",
