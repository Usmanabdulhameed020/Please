...
export default function RentDetails6() {
  const property = {
    id: 6,
    ...
    description:
      "Affordable self-contained unit in Oshodi, ideal for students or young professionals. Compact and cozy, with essential facilities.",
    features: [
      "1 Bedroom",
      "1 Toilet",
      "Fitted Kitchen",
