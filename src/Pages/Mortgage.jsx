...
export default function Mortgage() {
  ...
  const monthlyPayment = principalInterest + tax + insurance + hoa + mortgageIns;
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-8 text-gray-900">
      <h1 className="text-4xl font-bold mb-8 text-blue-700">Mortgage Calculator</h1>
      ...
      <div className="grid lg:grid-cols-3 gap-10 max-w-7xl mx-auto">
        ...
        <div className="lg:col-span-1 sticky top-8 h-fit space-y-6">
          ...
          <div className="h-3 w-full bg-gray-300 rounded-full overflow-hidden flex">
            <div style={{ width: `${(principalInterest / monthlyPayment) * 100}%` }} className="bg-blue-700"></div>
            <div style={{ width: `${(tax / monthlyPayment) * 100}%` }} className="bg-blue-500"></div>
            <div style={{ width: `${(insurance / monthlyPayment) * 100}%` }} className="bg-sky-600"></div>
            <div style={{ width: `${(hoa / monthlyPayment) * 100}%` }} className="bg-blue-300"></div>
            <div style={{ width: `${(mortgageIns / monthlyPayment) * 100}%` }} className="bg-indigo-400"></div>
          </div>
          ...
          <ul className="mt-4 space-y-2">
            <li className="flex justify-between">
              <span className="flex items-center gap-2">
                <span className="w-3 h-3 bg-blue-700 rounded-full"></span>Principal & interest
              </span>
            ...
            <li className="flex justify-between">
              <span className="flex items-center gap-2">
                <span className="w-3 h-3 bg-blue-500 rounded-full"></span>Property tax
              </span>
            ...
            <li className="flex justify-between">
              <span className="flex items-center gap-2">
                <span className="w-3 h-3 bg-sky-600 rounded-full"></span>Home insurance
              </span>
            ...
            <li className="flex justify-between">
              <span className="flex items-center gap-2">
                <span className="w-3 h-3 bg-blue-300 rounded-full"></span>HOA fees
              </span>
            ...
            <li className="flex justify-between">
              <span className="flex items-center gap-2">
                <span className="w-3 h-3 bg-indigo-400 rounded-full"></span>Mortgage insurance
              </span>
          ...
          <div className="grid grid-cols-1 gap-3 mt-6">
            {[
              ...
              "https://images.unsplash.com/photo-1598928717130-2d7e6f1c4b3a",
        ...
        <div className="lg:col-span-2 space-y-10">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              ...
              />
              <input type="range" min={500000} max={3000000} value={price}
                onChange={(e) => setPrice(Number(e.target.value))}
          ...
          <div className="bg-white shadow-xl p-6 rounded-2xl">
            <h2 className="text-xl font-semibold mb-4 text-blue-700">Loan Amortization</h2>
            ...
            <ResponsiveContainer width="100%" height={300}>
              <LineChart data={amortizationData}>
                ...
                <YAxis />
                <Tooltip />
                <Line type="monotone" dataKey="balance" stroke="blue" strokeWidth={3} />
              </LineChart>
            </ResponsiveContainer>
          </div>
          ...
          <div className="bg-white shadow-xl p-6 rounded-2xl">
            <h2 className="text-xl font-semibold mb-4 text-blue-700">Loan Eligibility</h2>

            <div className="grid md:grid-cols-3 gap-6">
              <div>
                <label className="font-semibold">Annual Income ($)</label>
                <input type="number" id="annualIncome"
