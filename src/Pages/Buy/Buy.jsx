...
export default function Buy() {
  ...
  const filtered = buyProperties.filter((prop) => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-20">
      ...
      <div className="relative w-full text-white py-20 text-center shadow-xl overflow-hidden"
        style={{backgroundImage: "url('https://images.unsplash.com/photo-1522708323590-d24dbb6b0267')", backgroundSize:'cover', backgroundPosition:'center'}}>
        <div className="absolute inset-0 bg-black/50"></div>
        <div className="relative z-10">
          <h1 className="text-5xl font-bold">Buy Your Dream Home</h1>
          <p className="mt-3 text-lg opacity-90">Explore premium properties available for purchase</p>
        </div>
      </div>
