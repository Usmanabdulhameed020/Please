...
export default function BuyDetails7() {
  const property = {
    id: 7,
    ...
    amount: 95000000,
    type: "Duplex",
    hero: "https://images.unsplash.com/photo-1580587771525-78b9dba3b914?auto=format&fit=crop&w=1500&q=80",
    gallery: [
      ...
      "https://images.unsplash.com/photo-1549488344-ec2476579f97?auto=format&fit=crop&w=1200&q=80",
    ],
    description:
      "A spacious and family-friendly duplex in a secure Gbagada neighborhood. Known for its ample natural light and sizable backyard perfect for children and gardening.",
    features: [
      "4 Bedrooms (Standard)",
